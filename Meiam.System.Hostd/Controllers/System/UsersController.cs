...
namespace Meiam.System.Hostd.Controllers.System
{
    ...
    public class UsersController : BaseController
    {
        ...
        public IActionResult Delete([FromBody] UsersDeleteDto parm)
        {
            ...
            predicate = predicate.And(m => parm.UserIds.Contains(m.UserID) && m.Administrator);
            bool hasAdmin = _usersService.Any(predicate.ToExpression());
            if (hasAdmin)
                return toResponse(StatusCodeType.Error, "无法删除系统管理员！");
